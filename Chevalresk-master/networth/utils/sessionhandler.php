<?php
  /*
    ...
    ce login.
  */
  function login($uID, $uEmail, $uName,$uImg,$uSolde,$isAdmin){
    $_SESSION["userID"] = $uID ;
    $_SESSION["userEmail"] = $uEmail;
    $_SESSION["userName"] = $uName;//alias
    $_SESSION["userProfileImage"] = $uImg;
    $_SESSION["userSolde"] = $uSolde;
  ...
  */
  function validate_session(){
    ...
    // peux aussi etre substituer par session_regenerate_id();
      ...
      $uImg = $_SESSION["userProfileImage"];
      $uSolde = $_SESSION["userSolde"];
      $isAdmin = $_SESSION["isAdmin"];

      end_session();
      session_start();
      login($uID, $uEmail, $uName,$uImg,$uSolde,$isAdmin);
      $status = true;
    }
    else {
      $_SESSION["timeOut"] = time() + (60 * 15);
