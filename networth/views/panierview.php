        ...
        //si le panier contient un item
            ...
            foreach ($items as $idItem) {
                ...
                foreach ($res as $column => $item) {
                    ...
                    $table .= '<td id="data"><b>Nom:</b>' . $item['nomItem'] . '</td>';
                    $table .= "<td id='data'><b>Qt:</b>$quantite</td>";

                    $table .= "
                    <td>
                        <form class='form-signin' method='POST' action='../user.dom/updatequantitepanier.dom.php?idItem=$idItem'>
                            <input type='number' name='Quantite' class='form-control' placeholder='Quantite voulue' autofocus required>
                    ...
                    $table .= '<td id="data" style="color:green;">Prix:' . $total . '</td>';
